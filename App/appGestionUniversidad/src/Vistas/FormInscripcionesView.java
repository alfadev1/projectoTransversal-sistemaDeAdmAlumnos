...
public class FormInscripcionesView extends javax.swing.JInternalFrame {
    ...
    private void jRBNoInscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRBNoInscActionPerformed
        // TODO add your handling code here:
        borrarFilas();
        // Realizar una conversión de tipo para obtener un objeto de tipo Alumno
        Alumno alu = (Alumno) jCBAlumnos.getSelectedItem();
        int id = alu.getIdAlumno();

        // Se crea y llena una lista de "Materia" con la lista devuelta por el método
...
//        }
    ...
    private void listarMaterias(List<Materia> lista) {
        for (Materia materia : lista) {
            modelo.addRow(new Object[]{materia.getIdMateria(), materia.getNombre(), materia.getAno()});
        }
    }
